...
public class MIController {
	...
	public String welcome() {
 		return "WELCOME TO MIController in smarteven-mock-disi";
	}
	...
	public String test() {
		 try {
	    	...
	    	System.out.println("	%%% MIController healthAdapterClient client to 8085=" + client );
	    	...
	    	System.out.println("	%%% MIController healthAdapterClient payload=" + payload );
			EnrollmentPayload ep = new EnrollmentPayload( );
			ep.setBody(payload);
	    	StatusReference answer = client.enrollment( ep );
		    System.out.println("	%%% MIController test ERROR=" +  answer.getLocation() );
	    	return "MIController test answer=" + answer.getLocation();
		 }catch( Exception e ) {
		    System.out.println("	%%% MIController test ERROR=" +  e.getMessage() );
			 return "MIController test ERROR:" + e.getMessage();
		 }
