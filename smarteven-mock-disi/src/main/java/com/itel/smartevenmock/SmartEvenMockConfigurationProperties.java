...
public class SmartEvenMockConfigurationProperties {
    ...
    public void setHealthAdapterBaseUrl(String healthAdapterBaseUrl) {
    	System.out.println("	%%% SmartEvenMockConfigurationProperties setHealthAdapterBaseUrl " + healthAdapterBaseUrl);
    ...
    public void setFhirServerBaseUrl(String fhirServerBaseUrl) {
    	System.out.println("	%%% SmartEvenMockConfigurationProperties setFhirServerBaseUrl " + fhirServerBaseUrl);
