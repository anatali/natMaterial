...
//console.log( "partialTemplates \n"+ partialTemplates );			//BY AN
 ...
 console.log("requestNumber=" + requestNumber);					//BY AN 
 console.log("uri=" + getDataTypeSpecificUrl('convert'));			//BY AN 
...
//console.log("outputLines=\n" + outputLines);			//BY AN the converted resource in JSON
...
//console.log("fieldSeparator=" + fieldSeparator);			//BY AN
//console.log("componentSeparator="+componentSeparator);		//BY AN
...
//console.log("startComponentIndex=" + startComponentIndex);					//BY AN
//console.log("endComponentIndex="   + endComponentIndex);					//BY AN
