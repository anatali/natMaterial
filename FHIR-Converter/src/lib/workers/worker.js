...
console.log("worker template=> " + template);				//BY AN
 ...
 /*
for( i=0;i<BYANgenratedRsult.fhirResource.result.entry.length;i++){
 console.log("worker fhirResource.result.entry["+i+"] " + Object.keys(BYANgenratedRsult.fhirResource.entry[i]));		
 //BY AN ( fullUrl,resource,request )
} 
*/
