...
var natstream   = fs.createWriteStream("/usr/src/app/src/NatLogStream.txt", {flags:'a'});	//BY AN
natstream.write("NatLogStream starts\n");	  //BY AN default option is AutoClose:true
...
console.log("routes /api/sample-data  " );	//BY AN
        messageCache.keys()
...
//fs.appendFile('NatLog.txt', '/api/templates', (err) => { if (err) throw err;  }) 		//BY AN
natstream.write('/api/templates\n');
        templateCache.keys()
...
//fs.appendFile('NatLog.txt', '/api/convert/:srcDataType', (err) => { if (err) throw err;  }) 		//BY AN
natstream.write('/api/convert/:srcDataType\n');
        workerPool.exec({
...
console.log("routes /api/convert/:srcDataType/:template(*)" );	                                    //BY AN
fs.appendFile('NatLog.txt', '/api/convert//:template(*)', (err) => { if (err) throw err;  }) 		//BY AN
natstream.write('/api/convert//:template(*)\n');
