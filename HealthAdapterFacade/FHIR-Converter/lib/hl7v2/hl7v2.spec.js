...
describe('hl7v2', function () {
    ...
    it('should throw when MSH segment does not contain separators.', function () {
        assert.throws(() => { hl7.parseHL7v2("MSH|||"); }, Error, "MSH segment missing separators!");
    });

    it('should throw when separators are not unique.', function () {
        assert.throws(() => { hl7.parseHL7v2("MSH|^~^#|"); }, Error, "Duplicate separators");
    });

    it('should throw when escape character is not backspace', function () {
        assert.throws(() => { hl7.parseHL7v2("MSH|^~#&|NES|NINTENDO|"); }, Error, "Escape character is *not* backspace. This has not been tested!");
    });
