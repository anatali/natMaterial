 ...
 */
 ...
 //console.log("worker result " + result);				//BY AN (NOT HERE)
...
/*
 ...
 console.log("worker entry[2].resource " + Object.keys(BYANgenratedRsult.fhirResource.entry[2].resource));		//BY AN (      )
 console.log("worker entry[3].resource " + Object.keys(BYANgenratedRsult.fhirResource.entry[3].resource));		//BY AN (      )
 console.log("worker entry[4].resource " + Object.keys(BYANgenratedRsult.fhirResource.entry[4].resource));		//BY AN (      )
 
 console.log("\n============================ worker GENERATED RESULT entry[0] ===========================================");
 ...
 console.log("\n============================ worker GENERATED RESULT entry[1] ===========================================");
 ...
 console.log("\n============================ worker GENERATED RESULT entry[2] ===========================================");
 console.log("worker entry[2].resource.resourceType " + BYANgenratedRsult.fhirResource.entry[2].resource.resourceType);		//BY AN ( Encounter   )
 console.log("worker entry[2].resource.id " + BYANgenratedRsult.fhirResource.entry[2].resource.id);		//BY AN (    )
 
 console.log("\n============================ worker GENERATED RESULT entry[3] ===========================================");
 console.log("worker entry[3].resource.resourceType " + BYANgenratedRsult.fhirResource.entry[3].resource.resourceType);		//BY AN ( Encounter   )
 console.log("worker entry[3].resource.id " + BYANgenratedRsult.fhirResource.entry[3].resource.id);		//BY AN (    )

 console.log("\n============================ worker GENERATED RESULT entry[4] ===========================================");
 console.log("worker entry[4].resource.resourceType " + BYANgenratedRsult.fhirResource.entry[4].resource.resourceType);		//BY AN ( Encounter   )
 console.log("worker entry[4].resource.id " + BYANgenratedRsult.fhirResource.entry[4].resource.id);		//BY AN (    )
 */
