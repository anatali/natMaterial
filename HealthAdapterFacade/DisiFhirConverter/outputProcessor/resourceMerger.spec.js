...
describe('resourceMerger', function () {
    var mergeTests = [
        ...
        {in: [{"entry": [ { "resource":{"resourceType":"Patient", "a":"1"}},
            {"resource":{"resourceType":"Patient","a":"2"}}]},{}],
        out: '{"entry":[{"resource":{"resourceType":"Patient","a":"2"}}]}'}, // last update wins

        {in: [{"entry": [ { "resource":{"resourceType":"Patient", "a":["1","2"]}},
            {"resource":{"resourceType":"Patient","a":["2","3"]}}]},{}],
        out: '{"entry":[{"resource":{"resourceType":"Patient","a":["1","2","3"]}}]}'}, // array concatenation

        {in: [{"entry": [ { "resource":{"resourceType":"Patient", "id":"1", "a":"1"}},
            {"resource":{"resourceType":"Patient", "id":"1", "a":"2"}},
            { "resource":{"resourceType":"Patient", "a":"3"}}]},{}],
        out: '{"entry":[{"resource":{"resourceType":"Patient","id":"1","a":"2"}},{"resource":{"resourceType":"Patient","a":"3"}}]}'}, // additional resource if different id
